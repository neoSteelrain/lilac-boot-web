...
public interface MemberMapper {
    ...
    int findMemberByNickName(@Param("nickName")String nickName);
    ...
    @Select("SELECT profile_save FROM tbl_member WHERE id=#{memberId}")
    String getMemberProfileSavePath(@Param("memberId")Long memberId);
}
