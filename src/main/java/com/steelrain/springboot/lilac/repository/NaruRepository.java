...
public class NaruRepository implements INaruRepository{
    ...
    @Override
    public NaruLibrarySearchByBookResponseDTO getLibraryByBook(long isbn, short region, int detailRegion) {
        ...
        NaruLibrarySearchByBookResponseDTO result = null;
        try(CloseableHttpClient httpClient = HttpClients.createDefault();
            ClassicHttpResponse response = httpClient.execute(httpGet)){
            HttpEntity entity = response.getEntity();
            ObjectMapper objectMapper = new ObjectMapper();
            result = objectMapper.readValue(entity.getContent(), NaruLibrarySearchByBookResponseDTO.class);
    ...
    @Override
    public NaruBookExistResposeDTO checkBookExist(long isbn, short libCode) {
